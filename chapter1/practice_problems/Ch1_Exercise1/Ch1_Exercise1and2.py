...
def generate_sorted_names_array(textfile_filepath):
...
def binary_search(array, search_index):
    ...
    if (search_index > len(array) - 1) or (search_index < 0):
...
names_array1 = generate_sorted_names_array('chapter1/practice_problems/Ch1_Exercise1/128_Names.txt')
...
names_array2 = generate_sorted_names_array('chapter1/practice_problems/Ch1_Exercise1/256_Names.txt')
